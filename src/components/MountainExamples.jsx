...
function MountainExamples() {
  ...
  return (
    ...
    >
        ...
        <p>City: Cambridge</p>
        <p>State: MA</p>
        <p><a href="https://www.harvardartmuseums.org/visit/exhibitions/3243">Harvard Website</a></p>

        {/* Horizontal Rule added for better visual separation between examples */}
        <hr style={{ width: '50%', margin: '20px 0' }} />

        <p>Title: Miniature Mountain with Daoist Paradise</p>
        <p>Desc: Sizable jade boulders of mountainous landscapes were carved to represent the search for the paradise or immortals' dwellings in the mountains. This Daoist theme has fired the Chinese imagination throughout history. Believed to have spiritual and magical properties, jade has long been used in tombs and intended for preserving the corporeal body and the soul in the quest for eternity. It is recorded that Daoist practitioners drank morning dews with scraps of jade as an elixir of immortality.</p>
        <img
        src="https://openaccess-cdn.clevelandart.org/1941.594/1941.594_web.jpg"
        width="200"
        height="200"></img>
        <p>Location:</p>
        <p>Street: 11150 East Blvd</p>
