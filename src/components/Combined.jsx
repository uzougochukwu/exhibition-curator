...
export default function Combined() {
  ...
  const [cleveland_term, setClevelandTerm] = useState("");
  const [cleveland_orderby, setClevelandOrderBy] = useState("");
...
{harvardArtworks.map((harvardArtwork) => {
  ...
  return (<div key={harvardArtwork.id}>
...
{clevelandArtworks.map((clevelandArtwork) => {
  ...
  return(<div key={clevelandArtwork.id}> 
